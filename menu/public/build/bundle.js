...
var app = (function () {
    ...
    /* src\components\Menu\MenuItem.svelte generated by Svelte v3.35.0 */
    const file$2 = "src\\components\\Menu\\MenuItem.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = text(t2_value);
    			attr_dev(h3, "class", "item-title svelte-1wwi2ue");
    			add_location(h3, file$2, 10, 2, 247);
    			attr_dev(p, "class", "item-description svelte-1wwi2ue");
    			add_location(p, file$2, 11, 2, 291);
    			attr_dev(div, "class", "menu-item svelte-1wwi2ue");
    			add_location(div, file$2, 9, 0, 187);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*handleItemClick*/ ctx[1](/*item*/ ctx[0]))) /*handleItemClick*/ ctx[1](/*item*/ ctx[0]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*item*/ 1 && t2_value !== (t2_value = /*item*/ ctx[0].desc + "")) set_data_dev(t2, t2_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const handleItemClick = item => {
    		Nui.send("Select:HandleClick", { item });
    	};
    	...
    	$$self.$capture_state = () => ({ Nui, item, handleItemClick });
    ...
    /* src\components\Menu\Menu.svelte generated by Svelte v3.35.0 */
    const file$1 = "src\\components\\Menu\\Menu.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*items*/ 1) menuitem_changes.item = /*item*/ ctx[1];
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 10, 0, 245);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ MenuItem, items });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 22, 0, 572);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
